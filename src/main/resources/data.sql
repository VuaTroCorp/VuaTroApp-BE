...
INSERT INTO post 
(title, price, status, area, room_quantity, address, description, longitude, latitude, user_id, type_id, created_at, updated_at)
VALUES

('Phòng trọ gần ĐH Nha Trang', 1500000, 'APPROVED', 20, 1,
'Nha Trang',
'Phòng trọ sạch sẽ, gần trường đại học Nha Trang',
109.1899, 12.2388, 1, 1, NOW(), NOW()),

('Căn hộ mini trung tâm', 3500000, 'APPROVED', 35, 2,
'Trần Phú, Nha Trang',
'Căn hộ mini đầy đủ nội thất, gần biển',
109.1920, 12.2400, 5, 2, NOW(), NOW()),

('Phòng trọ giá rẻ sinh viên', 1000000, 'APPROVED', 18, 1,
'Vĩnh Hải, Nha Trang',
'Phòng nhỏ phù hợp sinh viên, có wifi',
109.1850, 12.2500, 4, 1, NOW(), NOW()),

('Phòng trọ có gác', 2000000, 'APPROVED', 25, 1,
'Lê Hồng Phong, Nha Trang',
'Phòng trọ có gác lửng, rộng rãi thoáng mát',
109.2000, 12.2300, 2, 1, NOW(), NOW()),

('Căn hộ cao cấp', 5000000, 'APPROVED', 50, 2,
'Phạm Văn Đồng, Nha Trang',
'Căn hộ view biển, đầy đủ nội thất cao cấp',
109.2100, 12.2450, 3, 2, NOW(), NOW());